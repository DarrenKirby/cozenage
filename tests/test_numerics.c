...
//
//
// TestSuite(end_to_end_numerics);
//
// Test(end_to_end_numerics, test_add_integer, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_add_rational, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_add_complex, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
// Test(end_to_end_numerics, test_add_mixed, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_sub_integer, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_sub_rational, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_sub_mixed, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_mul_integer, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_mul_rational, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_mul_complex, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_div_rational, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_div_mixed, .init = setup_each_test, .fini = teardown_each_test) {
...
// }
//
// Test(end_to_end_numerics, test_numeric_greater_than, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test > */
//     // Basic integers
...
// }
//
// Test(end_to_end_numerics, test_numeric_less_than, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test < */
//     // Basic integers
...
// }
//
// Test(end_to_end_numerics, test_numeric_greater_than_equal, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test >= */
//     // Basic integers
//     cr_assert_str_eq(t_eval("(>= 3 2)"), "#true");
//     cr_assert_str_eq(t_eval("(>= 2 3)"), "#false");
...
// }
//
// Test(end_to_end_numerics, test_numeric_less_than_equal, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test <= */
//     // Basic integers
//     cr_assert_str_eq(t_eval("(<= 2 3)"), "#true");
//     cr_assert_str_eq(t_eval("(<= 3 2)"), "#false");
...
// }
//
// Test(end_to_end_numerics, test_zero_predicate, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test zero? */
...
// }
//
// Test(end_to_end_numerics, test_negative_predicate, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test negative? */
...
// }
//
// Test(end_to_end_numerics, test_positive_predicate, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test positive? */
...
// }
//
// Test(end_to_end_numerics, test_even_predicate, .init = setup_each_test, .fini = teardown_each_test) {
//     /* Test even? */
